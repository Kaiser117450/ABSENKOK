...
- [ ] **BUILD-01**: Operator can run the canonical Android release command from a clean checkout and reach release packaging without the current Dart compile failures.
