...
- **Before final phase verification:** run the full documented release lane with `powershell -ExecutionPolicy Bypass -File tool/release_build.ps1 -SmokeVerify`
...
- [ ] Full smoke-verified release run completes or records a concrete blocker for follow-up
