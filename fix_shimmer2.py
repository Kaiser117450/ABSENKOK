...
# Make sure we add the shimmer methods if not already there
...
"""
    ...
    # Replace the actual CircularProgressIndicator occurrences using string replacement
    # 1. Metrics Grid
    ...
    # Add missing ScaffoldMessenger
    content = content.replace("ScaffoldMessenger.of(context).showSnackBar(\n        SnackBar(\n          content: Text('Token berhasil diperbarui: $newToken'),\n          backgroundColor: AppColors.success,\n        ),\n      );", "AppToast.success(context, 'Token berhasil diperbarui: $newToken');")
